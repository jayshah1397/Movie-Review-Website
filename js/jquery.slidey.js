...
(function($) {
    $.slidey = function(el, options) {
        ...
        base.constructLayout = function() {
            ...
            // create controls
            var controls = "<div class='slidey-controls slidey-controls-previous'><i class=' fa-chevron-circle-left'></i></div>";
               controls += "<div class='slidey-controls slidey-controls-next'><i class=' fa-chevron-circle-right'></i></div>";
